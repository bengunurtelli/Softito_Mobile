...
class CreditCardPayment implements PaymentMethod {
  @override
  void pay(double amount) => print('$amount TL KREDİ KARTI İLE ÖDEME ALINDI');
}

class ApplePayPayment implements PaymentMethod {
  @override
  void pay(double amount) => print('$amount TL APPLE PAY İLE ÖDENDİ');
}
...
class Square extends Rectangle {
  ...
  void setWidth(double w) {
    width = w;
    height = w;
  } // kare olduğu için boyu eşitlendi
...
class BasicPrintir implements SmartDevice {
  @override
  void printDocument() => print('Yazdırılıyor');
  @override
  void scanDocument() => print('Taranıyor');
  @override
  void sendFax() => throw UnimplementedError('fax özelliğim yok'); //ISP İHLALI
}
